          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/images/cow1.png'),
                fit: BoxFit.cover,
              ),
            ),
                              ...
                              if (constraints.maxWidth < 800) {
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          // Use RichText to guarantee white color
                                          RichText(
                                            text: TextSpan(
                                              text: "Node ID (Cow ID)",
                                              style: TextStyle(
                                                  ...
                                                  style: TextStyle(
                                                    color: Theme.of(context)
                                                        ...
                                                        ? const Color.fromARGB(
                                                            255, 22, 3, 127)
                                                        : Colors
                                                            .black, // Make button text readable
                                                  ),
                                                ),
                                              ),
                                            ],
                                ...
                                return Row(
                                  ...
                                  children: [
                                    // Node ID field
                                    Column(
                                      // ADD THIS LINE TO CENTER THE LABEL AND INPUT
                                      crossAxisAlignment:
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextField(
                                            ...
                                            textAlign: TextAlign
                                                .center, // Center the input text itself
                                            decoration: InputDecoration(
                                              hintText: "Enter Node ID",
                                              hintStyle: TextStyle(
                                                  color: Color.fromARGB(
                                    ...
                                    // Start Date & Time
                                    Column(
                                      // ADD THIS LINE FOR CONSISTENT CENTERING
                                      crossAxisAlignment:
                                          CrossAxisAlignment.center,
                                      children: [
                                        Text("Start Date & Time",
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          top: 24.0), // Adjust padding to align
                                      child: ElevatedButton(
                                        onPressed: _fetchData,
                                        child: Text(
                                          "Fetch Data",
